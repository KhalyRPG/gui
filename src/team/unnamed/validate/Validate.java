 ...
 * <p>
 * Created for code shortening and for making legible code. Make fail-fast
 * methods.
 * <p>
 * Example with {@link Validate}: <code>
 * public void setName(String name) {
 * this.name = Validate.notEmpty(name);
 * }
 * </code> Example without {@link Validate}: <code>
 * public void setName(String name) {
...
public final class Validate {
	...
	/**
	 * Validates that the provided object isn't null, if it is, the method throws an
	 * {@link NullPointerException} with the specified message.
	 * 
	 * @param object     The checked object
	 * @param message    The exception message
	 * @param parameters Parameters for the message, message is formatted using
	 *                   {@link String#format}.
	...
	/**
	 * Validates that the specified expression is true, if it is false, the method
	 * throws a {@link IllegalStateException} with the specified message.
	 * 
	 * @param expression The checked expression
	 * @param message    The message for the thrown exception
	 * @param parameters The parameters for the exception message. The message is
	 *                   formatted using {@link String#format}.
	...
	/**
	 * Validates that the specified expression is true, if it is false, the method
	 * throws a {@link IllegalArgumentException} with the specified message
	 * 
	 * @param expression The checked expression
	 * @param message    The message for the thrown exception
	 * @param parameters The parameters for the exception message. The message is
	...
	/**
	 * Validates that the specified string is not null and not empty. If the string
	 * is null, throws a {@link NullPointerException}, if the string is empty,
	 * throws a {@link IllegalArgumentException}.
	 * 
