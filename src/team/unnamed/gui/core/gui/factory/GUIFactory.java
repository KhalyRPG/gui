...
public final class GUIFactory {
	...
	static {
		try {
			GUI_CONSTRUCTOR = Class
					.forName("team.unnamed.gui.v" + SERVER_VERSION + ".CraftGUIInventory" + SERVER_VERSION)
	...
	public static Inventory create(GUIData guiData) {
		try {
			GUIInventory guiInventory = (GUIInventory) GUI_CONSTRUCTOR.newInstance(null, guiData);
