...
public class SimpleGUIData implements GUIData {
	...
	protected SimpleGUIData(String title, int slots, List<ItemClickable> items,
			Predicate<InventoryOpenEvent> openAction, Consumer<InventoryCloseEvent> closeAction, boolean cancelClick) {
		this.title = title;
		this.slots = slots;
		this.items = items;
